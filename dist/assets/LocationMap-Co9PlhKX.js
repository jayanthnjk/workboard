const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-D1YY86Lq.js","assets/index-sNAAkHpH.js","assets/index-vV5YJklJ.css","assets/leaflet-Dgihpmma.css"])))=>i.map(i=>d[i]);
import{r as o,j as k,_ as $}from"./index-sNAAkHpH.js";const h={lat:12.8714,lng:74.8425},N=14,j={"government-office":"Government Office","bank-currency-chest":"Bank Currency Chest",court:"Court",hospital:"Hospital",ncc:"NCC"},A={"government-office":"#3B82F6","bank-currency-chest":"#22C55E",court:"#8B5CF6",hospital:"#EF4444",ncc:"#1B4D3E"},R={"government-office":"🏛️","bank-currency-chest":"🏦",court:"⚖️",hospital:"🏥",ncc:"🎖️"};function P({locations:u,onSelectLocation:b,selectedLocationId:d}){const g=o.useRef(null),i=o.useRef(null),f=o.useRef(new Map),v=o.useRef(u),E=o.useRef(null);v.current=u;const m=o.useRef(b);m.current=b;const y=o.useRef(d);y.current=d;const C=o.useCallback(x=>{var t;(t=m.current)==null||t.call(m,x)},[]);o.useEffect(()=>!g.current||i.current?void 0:((async()=>{const t=await $(()=>import("./leaflet-src-D1YY86Lq.js").then(e=>e.l),__vite__mapDeps([0,1,2]));await $(()=>Promise.resolve({}),__vite__mapDeps([3])),E.current=t;const r=t.map(g.current,{center:[h.lat,h.lng],zoom:N,zoomControl:!1,scrollWheelZoom:!0,attributionControl:!1});t.control.zoom({position:"topright"}).addTo(r),t.control.attribution({position:"bottomright",prefix:!1}).addAttribution('&copy; <a href="https://www.openstreetmap.org/copyright">OSM</a>').addTo(r),t.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19}).addTo(r),u.forEach(e=>{if(!e.lat||!e.lng)return;const p=A[e.type]||"#1B4D3E",n=R[e.type]||"📍",l=j[e.type]||e.type,s=t.divIcon({className:"custom-marker",html:`<div style="
