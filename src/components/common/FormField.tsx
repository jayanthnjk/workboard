        ...
        {value.length === 0 ? (
          ...
          value.map(v => {
            ...
            return (
              <span
                key={v}
                className="inline-flex items-center gap-1 px-2 py-0.5 bg-[var(--color-primary)]/10 text-[var(--color-primary-dark)] rounded text-sm"
              >
                {opt?.label || v}
                <button
                  type="button"
        ...
        {options
          ...
          .map(opt => (
            <button
              ...
              className="px-2 py-1 text-sm bg-[var(--color-bg-main)] hover:bg-[var(--color-border)] rounded transition-colors"
            >
              + {opt.label}
            </button>
          ))}
